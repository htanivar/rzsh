# JQ JSON Parser Module Reference

- **Source File:** [`functions/14-jq.sh`](file:///home/ubuntu/code/github/raviautopilot/rWork/shared/rzsh/functions/14-jq.sh)
...
### Integration Setup
To use the JQ JSON Parser module, you only need to source the configuration script, which automatically imports it:
